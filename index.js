    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    cwd = process.cwd();
                    sshOption = getConfig_1["default"].server;
                    if (!sshOption) {
                        console.log('not valid config');
                        return [2 /*return*/];
                    }
                    rootPath = path_1["default"].join(cwd);
                    console.log(getConfig_1["default"]);
                    targetPath = path_1["default"].join(rootPath, getConfig_1["default"].upload.localPath);
                    fs_extra_1["default"].readdirSync(targetPath).forEach(function (each) {
                        if (getConfig_1["default"].upload.fileRex.test(each)) {
                            zipPath = path_1["default"].join(targetPath, each);
                        }
                    });
                    if (!zipPath) {
                        throw new Error('no zip file');
                    }
                    zipFileName = path_1["default"].basename(zipPath);
                    remotePath = getConfig_1["default"].upload.remotePath;
                    return [4 /*yield*/, upload_1["default"](sshOption, zipPath, remotePath)];
                case 1:
                    uploadRes = _a.sent();
                    if (uploadRes) {
                        if (!zipFileName) {
